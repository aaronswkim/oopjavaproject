 ...
 */
	...
	public void displayMenu() {
	    if (trays.isEmpty()) {
	        ...
	        trays.forEach(tray -> tray.forEach(item -> System.out.println(item)));
	    }
	}
...
class UsingVm { 
    ...
    //protected HashMap<BeverageItem, Integer> orderItems = new HashMap<>();

    // 주문 물품 추가
    
    /*
    public void addItem(BeverageItem item, int quantity) {
        if (item != null) {
...
public class VendingMachine {
    ...
    private static void addMenuItem() {
        ...
        int stock = sc_add.nextInt(); // 가격 입력 받기
